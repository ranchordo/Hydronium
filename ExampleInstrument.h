...
class ExampleInstrument : public Instrument<2> { //2 subsystems, that's why <2>.
  ...
  ExampleInstrument(PersistentMemoryBlock* memoryBlock, InfoInterface* serial, int param1, int param2): //Weird syntax, but it's a member initializer
    Instrument(memoryBlock, serial),

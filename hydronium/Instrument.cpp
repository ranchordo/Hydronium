...
template<int numSubsystems>
void Instrument<numSubsystems>::process() {
...
template<int numSubsystems>
void Instrument<numSubsystems>::deep_sleep_start() {
  esp_deep_sleep_start();
}

template<int numSubsystems>
void Instrument<numSubsystems>::setSecondLevelAlarm(uint64_t time) {
  esp_sleep_enable_ext0_wakeup(GPIO_NUM_0, 0);
  //TODO: Fix
}
template<int numSubsystems>
void Instrument<numSubsystems>::setAlarmMilliseconds(uint16_t ms) {
